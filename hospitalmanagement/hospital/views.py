...
#for showing signup/login button for admin(by Abhi)
...
#for showing signup/login button for doctor(by Abhi)
...
#for showing signup/login button for patient(by Abhi)
...
#-----------for checking user is doctor , patient or admin(by Abhi)
def is_admin(user):
...
#Youtube :youtube.com/hospital nova
